...
func (a *array) set(seq int64, p unsafe.Pointer) {
	a.elementAt(seq).p = p
}

func (a *array) get(seq int64) (p unsafe.Pointer) {
	p = a.elementAt(seq).p
	return
}
...
func (b *arrayBuffer) Send(i unsafe.Pointer) (err error) {
	if b.sts.isClosed() {
...
func (b *arrayBuffer) Recv() (value unsafe.Pointer, active bool) {
	active = true
